...
public class Upload
{
    ...
    public async Task<string> Execute(FileInfo file)
    {
        ...
        request.Headers.Add("baggage", "sentry-environment=production,sentry-release=hPZj-aOLuqQ3QUlWq1JLg,sentry-public_key=b311e0f2690c81f25e2c4cf6d4f7ce1c,sentry-trace_id=1d3c39112d8f40f0a57213ef7512263d,sentry-sample_rate=1,sentry-sampled=true");
        request.Headers.Add("sentry-trace", "1d3c39112d8f40f0a57213ef7512263d-a5ede8804be57bba-1");
